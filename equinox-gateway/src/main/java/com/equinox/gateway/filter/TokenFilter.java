...
import com.equinox.gateway.constants.AppConstants;
import com.equinox.gateway.result.CommonResult;
...
public class TokenFilter implements GlobalFilter, Ordered {
    ...
    private Mono<Void> operationExchange(ServerWebExchange exchange, GatewayFilterChain chain, String newBody) {
        ...
        // read & modify body
        ServerRequest serverRequest = null;//new DefaultServerRequest(exchange);
